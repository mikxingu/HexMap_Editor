...
public class HexFeatureManager : MonoBehaviour
{
	...
	public void AddWall(EdgeVertices near, HexCell nearCell, EdgeVertices far, HexCell farCell, bool hasRiver, bool hasRoad)
	{
		if (nearCell.Walled != farCell.Walled &&
			!nearCell.IsUnderwater && !farCell.IsUnderwater && nearCell.GetEdgeType(farCell) != HexEdgeType.Cliff)
		{
	...
	public void AddBridge (Vector3 roadCenter1, Vector3 roadCenter2)
	{
		...
		instance.localScale = new Vector3(1f, 1f, length * (1f / HexMetrics.bridgeDesignLenth));
		instance.SetParent(container, false);
	}
